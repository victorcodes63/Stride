...
export const ROADMAP_PAGES: Record<string, RoadmapPageConfig> = {
  procurement: {
    ...
    summary:
      'Purchase-to-pay: requests, approvals, LPO generation, goods receipt, and spend visibility. Vendor master lives under Finance.',
    bullets: [
      'Purchase request workflow with approvals',
      'LPO PDF generation and vendor dispatch',
      'Goods receipt linked to vendor bills',
  ...
  'projects-board': {
    ...
    readiness: 'live',
    phase: 'Phase D1',
    summary: 'Kanban view across project tasks — move cards between backlog, in progress, and done.',
    bullets: ['Filter by project', 'Priority indicators on cards', 'Status updates sync to task list'],
    related: [
      { label: 'All projects', href: '/dashboard/projects/all' },
      { label: 'Tasks list', href: '/dashboard/projects/tasks' },
    ],
  },
  'projects-tasks': {
    slug: 'projects-tasks',
    ...
    readiness: 'live',
    phase: 'Phase D1',
    summary: 'Task assignments and completion tracking tied to project milestones.',
    bullets: ['Create tasks per project', 'Filter by status', 'Assignee and due date fields'],
    related: [
      { label: 'Project board', href: '/dashboard/projects/board' },
      { label: 'All projects', href: '/dashboard/projects/all' },
    ],
