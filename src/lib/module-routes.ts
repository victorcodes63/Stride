...
export const ROUTE_MODULE_BINDINGS: RouteModuleBinding[] = [
  ...
  { prefix: '/dashboard/admin/governance', module: 'core' },
  ...
  { prefix: '/api/ess/fleet', module: 'fleet' },
  { prefix: '/api/ess/hse', module: 'hse' },
  { prefix: '/ess/fleet', module: 'fleet' },
  ...
  { prefix: '/api/sacco', module: 'sacco' },
  { prefix: '/dashboard/sacco', module: 'sacco' },
  { prefix: '/api/healthcare', module: 'healthcare' },
  { prefix: '/dashboard/healthcare', module: 'healthcare' },
  { prefix: '/api/energy', module: 'energy' },
  { prefix: '/dashboard/energy', module: 'energy' },
  { prefix: '/api/construction', module: 'construction' },
  { prefix: '/dashboard/construction', module: 'construction' },
