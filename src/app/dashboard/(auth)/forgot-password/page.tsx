...
export default function ForgotPasswordPage() {
  ...
  return (
    <LoginPageShell
      ...
      welcomeSubtitle="Enter your work email and we'll send reset instructions for your Stride staff account."
    >
      <LoginCard>
        <h2 className="dash-auth-title">Forgot your password?</h2>
